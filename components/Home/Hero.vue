    ...
    <div class="container flex flex-col items-center text-center gap-5 md:gap-20 md:flex-row md:items-center md:justify-between mt-[-15px] overflow-hidden">
        ...
        <div class="lg:ml-16 mt-8 flex flex-col gap-[-3px] lg:items-start justify-between items-center">
                ...
                <div class="font-custom mt-[22px] font-bold relative w-[688px] text-center lg:text-start">
                    ...
                    <div class="hidden md:block z-[-1] absolute top-[112px] lg:left-[125px]">
                        <img src="/img/Hero/Vector 6.png" alt="" class="w-[110px]">
                    </div>
                    <div class=" hidden md:block z-[-1] absolute top-[185px] lg:left-[307px]">
                        <img src="/img/Hero/Vector 6.png" alt="" class="w-[160px]">
                    </div>
                </div>
        ...
        <!--Right content-->
        <div class="mt-6 md:w-[896px] md:h-[633.8px]">
            <div class="absolute top-[90px] hidden md:block  md:left-[650px] md:top-[190px]"> 
                <img src="/img/Hero/man.png" alt="man">
            </div>
            <div class="absolute  hidden md:block md:top-[350px] right-[140px]">
                <img src="/img/Hero/analytics.png" alt="man" width="94px" height="94px">
            </div>
            <div class="absolute hidden md:block md:right-[395px] md:top-[510px]">
                <img src="/img/Hero/stat.png" alt="man" class=" w-[150px] md:w-[270px] md:h-[100px]">
            </div>
        </div>
    </div>
</template>
